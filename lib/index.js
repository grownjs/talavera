...
module.exports = function() {
  ...
  options.dest = path.relative(cwd, path.join(this.opts.dest, options.dest || ''));
  options.public = path.relative(cwd, path.join(this.opts.public, options.public || ''));
